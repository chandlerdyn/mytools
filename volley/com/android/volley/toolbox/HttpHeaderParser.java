 ...
 *<p>Http header 的解析工具类，在 Volley 中主要作用是用于解析 Header 从而判断返回结果是否需要缓存，
 *如果需要返回 Header 中相关信息。
 */
public class HttpHeaderParser {
     ...
     *<p>比较重要的方法，通过网络响应中的缓存控制 Header 和 Body 内容，构建缓存实体。
     *如果 Header 的 Cache-Control 字段含有no-cache或no-store表示不缓存，返回 null。
     ...
     * <p>解析时间，将 RFC1123 的时间格式，解析成 epoch 时间 
     */
     ...
     * <p>解析编码集，在 Content-Type 首部中获取编码集，如果没有找到，默认返回 ISO-8859-1 
     */
